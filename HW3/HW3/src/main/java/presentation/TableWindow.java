...
/**
 * The secondary window created for each table
 * 
 * @author IndreBogdan
 *
 */
public class TableWindow extends JFrame {
	...
	/**
	 * the id to know for which table the TableWindow is created 
	 * id = 1 -> Clients;
	 * id = 2 -> Products;
	 * id = 3 -> Orders;
	 * id = 4 -> Stock;
	...
	private int[] size = { 0, 4, 3, 6, 2 }; // the number of fields for each table
